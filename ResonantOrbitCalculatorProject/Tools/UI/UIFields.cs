...
namespace ResonantOrbitCalculator.UI
{
    public class UI_Fields
    {
        ...
        public static ManualLogSource logger = BepInEx.Logging.Logger.CreateLogSource("ROC.MainUI");
        ...
        public static double DoubleField(string entryName, double value)
        {
            ...
            text_value = GUILayout.TextField(text_value, ROCStyles.textInputStyle); // GUILayout.Width(100));
        ...
        public static int IntField(string entryName, int value) // int min = 0, string tooltip = ""
        {
            ...
            GUI.SetNextControlName(entryName);
            var typed_text = GUILayout.TextField(text_value, ROCStyles.textInputStyle);
