...
public class ROCStyles
{
    ...
    public static int spacingAfterHeader;
    public static int spacingAfterEntry;
    public static int spacingAfterSection;
    ...
    static void BuildFrames()
    {
        ...
        spacingAfterHeader = -12;
        spacingAfterEntry = -12;
        spacingAfterSection = 5;
    }
