...
public class ResonantOrbitCalculatorPlugin : BaseSpaceWarpPlugin
{
    ...
    {
        GUILayout.Label("Resonant Orbit Calculator - Calculate resonant orbits for the selected vessel and assit with setting up maneuver nodes to enter the resonant orbit");
